...
ResourceGroupViewImpl::ResourceGroupViewImpl(hipro::log::Logger* logger,
  Glib::RefPtr<Gtk::Builder> builder,
  Gtk::Window* parent)
  : logger(logger), m_parent(parent)
{
  ...
  m_ent_name->signal_changed().connect(
    sigc::mem_fun(*this, &ResourceGroupViewImpl::cb_on_group_name_changed));

  Gtk::Button* btn = nullptr;
  builder->get_widget("btn-save", save_btn);
...
void
ResourceGroupViewImpl::enable_save(bool f)
{
...
void
ResourceGroupViewImpl::cb_on_group_name_changed(void)
{
  m_handler->view_group_name_changed();
}
